...
namespace Search
{
    class Dom : IStrategy
    {
        ...
        public List<Student> Algorithm(Student student, string path)
        {
            ...
            try
            {
                if (student.Dorm != null) info.Add(SearchByParam("dorm", "DORM", student.Dorm, doc, 0));
                if (student.Floor != null) info.Add(SearchByParam("floor", "FLOOR", student.Floor, doc, 1));
        ...
        public static Student Info(XmlNode node)
        {
            ...
            nw.Dorm = node.ParentNode.ParentNode.Attributes.GetNamedItem("DORM").Value;
            nw.Floor = node.ParentNode.Attributes.GetNamedItem("FLOOR").Value;
        ...
        public static List<Student> AllStudents(XmlDocument doc)
        {
            ...
            XmlNodeList elem = doc.SelectNodes("//students");
            try
            {
